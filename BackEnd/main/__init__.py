...
# from BackEnd.main.survival_regression_get_regular_test_features_03 import survival_reg_features
# from BackEnd.main.survival_regression_get_test_features_03 import get_features
# from BackEnd.main.survival_regression_pre_test_label_03 import survival_pred
from BackEnd.main.survival_regression_pre_test_label_03_23_04 import survival_prediction
...
def wxcode():
    ...
    case_state = request.form.get('case_state')
    # print(num)
    detail = start(str(num),age,case_state)
    # detail = 'this is a test\n' \
    #          'and i want to know if it works\n' \
    #          'but it might be hard to accomplish\n'
...
def livepred():
    ...
    y_pred = survival_prediction(age,state)
    # y_pred = '中（10-15个月）'
    # print(age,state,y_pred)
