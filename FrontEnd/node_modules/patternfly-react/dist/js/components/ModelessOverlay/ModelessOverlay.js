...
var ModelessOverlay = function (_React$Component) {
  ...
  function ModelessOverlay(props) {
    ...
    _this.inTimer = new _Timer2.default(_this.updateForTransitions, 150);
    return _this;
  }
  ...
  _createClass(ModelessOverlay, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames2.default)('modal modeless-pf fade right-side-modal-pf', { shown: show || isIn, in: show && isIn }, className);
      ...
      var dialogClasses = (0, _classnames2.default)('modal-dialog', {
        'modal-sm': bsSize === 'sm' || bsSize === 'small',
        'modal-lg': bsSize === 'lg' || bsSize === 'large'
      });
      return _react2.default.createElement(
        'div',
        _extends({ role: 'dialog', tabIndex: -1, className: classes }, (0, _helpers.excludeKeys)(otherProps, ['show'])),
...
ModelessOverlay.propTypes = {
  ...
  bsSize: _propTypes2.default.oneOf(['lg', 'large', 'sm', 'small', 'default'])
};
...
exports.default = ModelessOverlay;