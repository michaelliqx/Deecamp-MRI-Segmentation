...
def pred_brats(df, detect_func, output_file="out"):
    """
    prediction
    """
    df.reset_state()
    gts = []
    results = []
    no_ET = ['BraTS19_TCIA10_232_1', 'BraTS19_TCIA12_146_1', 'BraTS19_TCIA13_626_1', 'BraTS19_TCIA10_195_1',
             'BraTS19_TCIA10_127_1', 'BraTS19_TCIA10_614_1', 'BraTS19_TCIA13_646_1',
             'BraTS19_TCIA12_641_1', 'BraTS19_TCIA09_381_1', 'BraTS19_TCIA12_613_1', 'BraTS19_TCIA10_631_1',
             'BraTS19_TCIA09_225_1', 'BraTS19_TCIA10_236_1', 'BraTS19_TCIA09_248_1']
    with tqdm.tqdm(total=df.size(), **get_tqdm_kwargs()) as pbar:
        for filename, image_id, data in df.get_data():
            final_label, probs = detect_func(data)
            if config.TEST_FLIP:
            ...
            if config.ADVANCED_POST_PROCESSING:
                if image_id in no_ET:
                    final_label[final_label == 4] = 1

            save_to_nii(final_label, image_id, outdir=output_file, mode="label")
